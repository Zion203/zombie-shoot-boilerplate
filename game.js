...
const background_Sound = new Audio("./assets/bgm.mp3");
...
function makeZombie() {
  ...
  gameBody.innerHTML += `<img src="./assets/${randomImage}" class="zombie-image" id="zombie${zId}">`;
  let zombie = document.getElementById("zombie" + zId);
